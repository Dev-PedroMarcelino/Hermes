...
import { encryptCredential } from './engine/src/services/vaultService.js';
  ...
  if (hasCredentials) {
    try {
      ...
      if (err.message.includes('UNAUTHENTICATED')) {
        ...
        console.log('1. Certifique-se de sincronizar o relógio do Windows ("Definir hora automaticamente").');
